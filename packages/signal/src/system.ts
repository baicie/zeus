...
export function isSignal(fn: unknown): boolean {
  return typeof fn === 'function' && fn.name === 'bound ' + signalOper.name
}

export function isComputed(fn: unknown): boolean {
  return typeof fn === 'function' && fn.name === 'bound ' + computedOper.name
}

export function isEffect(fn: unknown): boolean {
  return typeof fn === 'function' && fn.name === 'bound ' + effectOper.name
}

export function isEffectScope(fn: unknown): boolean {
  return typeof fn === 'function' && fn.name === 'bound ' + effectScopeOper.name
}
