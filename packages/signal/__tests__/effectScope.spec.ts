// TODO: commented out - depends on @vue/runtime-core (nextTick, watch, watchEffect)
...
describe('reactivity/effect/scope', () => {
  ...
  it('can not run an inactive scope', () => {
    ...
    expect(
      '[Zeus warn] cannot run an inactive effect scope.',
    ).toHaveBeenWarned()
  ...
  it('should warn onScopeDispose() is called when there is no active effect scope', () => {
    ...
    expect(
      '[Zeus warn] onScopeDispose() is called when there is no active effect scope to be associated with.',
    ).toHaveBeenWarned()
  ...
  // TODO: commented out - uses @vue/runtime-core (watch, watchEffect, nextTick)
  ...
  // TODO: commented out - uses @vue/runtime-core (nextTick)
  ...
  // TODO: commented out - uses @vue/runtime-core (nextTick, watch)
