...
describe('z-checkbox', () => {
  ...
  beforeAll(async () => {
    ...
    await import('../src/checkbox/checkbox')
  })
  ...
  it('toggles checked state and emits checked-change', async () => {
    document.body.innerHTML = '<z-checkbox>Accept</z-checkbox>'
    const el = document.querySelector('z-checkbox') as HTMLElement & {
      checked?: boolean
    }
  ...
  it('transitions from indeterminate to checked', async () => {
    document.body.innerHTML = '<z-checkbox indeterminate></z-checkbox>'
    const el = document.querySelector('z-checkbox') as HTMLElement & {
      checked?: boolean
  ...
  it('blocks interaction while disabled', async () => {
    document.body.innerHTML = '<z-checkbox disabled></z-checkbox>'
    const el = document.querySelector('z-checkbox') as HTMLElement & {
      checked?: boolean
    }
    const listener = vi.fn()
