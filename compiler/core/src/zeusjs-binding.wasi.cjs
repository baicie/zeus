...
const __wasmDebugFilePath = __nodePath.join(
  __dirname,
  'zeusjs-binding.wasm32-wasi.debug.wasm',
)
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath =
      require.resolve('@zeus-js/binding-wasm32-wasi/zeusjs-binding.wasm32-wasi.wasm')
  } catch {
    throw new Error(
      'Cannot find zeusjs-binding.wasm32-wasi.wasm file, and @zeus-js/binding-wasm32-wasi package is not installed.',
    )
  }
}
